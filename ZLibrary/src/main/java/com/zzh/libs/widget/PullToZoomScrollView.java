...
import com.zzh.libs.base.PullToZoomBase;
import com.zzh.zlibrary.R;
...
public class PullToZoomScrollView extends PullToZoomBase<ScrollView> {
    ...
    public void setHideHeader(boolean hideHeader) {
        if (hideHeader != isHideHeader() && mHeaderContainer != null) {
    ...
    public void handleStyledAttributes(TypedArray ta) {
        ...
        int contentViewResId = ta.getResourceId(R.styleable.PullToZoomRecyclerView_contentView, 0);
