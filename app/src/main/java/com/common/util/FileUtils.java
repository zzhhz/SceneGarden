...
public class FileUtils {
    ...
    public String readFromAsset(String fileName) {
        ...
        try {
            is = ShopApplication.getInstance().getAssets().open(fileName);
    ...
    private FileUtils() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
            BASE_PATH = ShopApplication.getAppFileDir()
                    + "/camera/";
        } else {
            BASE_PATH = ShopApplication.getInstance().getCacheDirPath();
        }
    ...
    public File getCacheDir() {
        return ShopApplication.getInstance().getCacheDir();
    }
